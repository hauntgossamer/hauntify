...
# The 'pynput' library is now used for global media key control.
# It is more reliable on different Linux desktop environments and does not require root permissions.
...
root = Tk()
# Comment or uncomment the appropriate Edition
root.title('Hauntify Version 1.0.0.0 Linux Edition')
# root.title('Hauntify Version 1.0.0.0 Windows Edition')
root.resizable(True, True)
# Comment or uncomment appropriately
...
def on_key_press(key):
    """ Callback function for the pynput listener on key press. """
    try:
        ...
        # This handles other keys that don't have a media key attribute
        pass

def setup_global_hotkeys():
    """ Sets up the global hotkeys for media controls using pynput. """
